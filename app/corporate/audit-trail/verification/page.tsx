...
import { ArrowLeft, Shield, Package, Share2, Clock, CheckCircle } from "lucide-react";
...
export default function CorporateVerificationPage() {
  ...
  const plannedFeatures = [
    {
      icon: Package,
      title: "Verification Package Generation",
      description: "Automatically compile all required documents and data for ACVA verification",
    },
    {
      icon: Share2,
      title: "Secure Sharing",
      description: "Share verification packages securely with auditors and regulatory bodies",
    },
    {
      icon: Clock,
      title: "Access Management",
      description: "Control access duration and permissions for shared verification packages",
    },
    {
      icon: CheckCircle,
      title: "Compliance Tracking",
      description:
        "Track verification status and compliance across all plants in your organization",
    },
  ];
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[13px] text-[#0A0A0A]/60 mt-0.5">
                Generate and manage ACVA verification packages for compliance across all plants
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-[#050505]/6 p-8 text-center">
            ...
            <p className="text-[14px] text-[#0A0A0A]/60 leading-relaxed max-w-md mx-auto">
              Verification package management is currently under development. This feature will
              allow you to generate, manage, and share ACVA verification packages across all your
              plants for streamlined compliance.
            </p>
