      ...
      <div className="mx-auto max-w-[1600px] px-6 py-6">
        <header className="mb-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Drop one or more utility bills, invoices, or reports. The assistant
            reads each one, proposes metrics, and you review before saving. Up to{" "}
            {MAX_CONCURRENT} run in parallel; the rest queue automatically.
          </p>
        </header>
